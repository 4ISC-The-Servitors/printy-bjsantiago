...
// Removed generateOrderId function - display_id is now auto-generated by database triggers
...
async function createOrderFromCompilation(_ctx: any): Promise<any> {
    ...
    const compiledOrder: OrderData = {
        // order_id will be auto-generated by database (UUID)
        // display_id will be auto-generated by database trigger
