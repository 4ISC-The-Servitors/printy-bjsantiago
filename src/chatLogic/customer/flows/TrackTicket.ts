...
const NODES: Record<string, Node> = {
  track_ticket_start: {
    ...
    message: "Hi! I'm Printy 🤖. I can help you track your support ticket. Do you have your ticket number?",
    options: [
  ...
  has_ticket_number: {
    ...
    answer: 'Great! Please provide your ticket number (e.g., TCK-000123) and I will check the status for you.',
    options: [
  ...
  no_ticket_number: {
    ...
    answer: 'No problem! I can help you find your ticket. What email address did you use when creating the ticket?',
    options: [
  ...
  search_by_email: {
    ...
    answer: 'I will search for tickets associated with your email address. Please provide the email you used.',
    options: [
