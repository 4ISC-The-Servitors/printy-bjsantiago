...
const NODES: Record<string, Node> = {
  ...
  business_cards: {
    ...
    answer:
      'Our business cards are printed on premium cardstock with options for matte, glossy, or textured finishes. We offer standard sizes and custom dimensions.',
    options: [
  ...
  flyers_brochures: {
    ...
    answer:
      'We print high-quality flyers and brochures on various paper weights and finishes. Perfect for marketing campaigns and informational materials.',
    options: [
      { label: 'Other Services', next: 'other_services' },
      { label: 'End Chat', next: 'end' },
    ],
  ...
  large_format: {
    ...
    answer:
      'Our large format printing includes banners, posters, vehicle wraps, and signage. We use high-quality materials and advanced printing technology.',
    options: [
      { label: 'Other Services', next: 'other_services' },
      { label: 'End Chat', next: 'end' },
    ],
  ...
  digital_printing: {
    ...
    answer:
      'Digital printing is perfect for quick turnaround jobs, variable data printing, and short runs. We offer high-quality results with fast production times.',
    options: [
      { label: 'Other Services', next: 'other_services' },
      { label: 'End Chat', next: 'end' },
    ],
  ...
  other_services: {
    ...
    answer:
      'We also offer binding, laminating, die-cutting, embossing, and finishing services. To get detailed pricing and place orders, you will need to create an account.',
    options: [
  ...
  create_account: {
    ...
    answer:
      'Great idea! Creating an account will give you access to detailed pricing, order tracking, and exclusive customer benefits. Would you like to sign up now?',
