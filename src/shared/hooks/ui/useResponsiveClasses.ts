...
export function useResponsiveClasses() {
  ...
  const buttonClasses: ResponsiveButtonClasses = useMemo(
    () => ({
      ...
      tertiary:
        'h-6 px-2 text-xs sm:h-7 sm:px-3 sm:text-sm md:h-8 md:px-4 md:text-base lg:h-9 lg:px-5 lg:text-lg',
  ...
  const badgeClasses: ResponsiveBadgeClasses = useMemo(
    () => ({
      ...
      padding:
        'px-1.5 py-0.5 sm:px-2 sm:py-0.5 md:px-2.5 md:py-1 lg:px-3 lg:py-1',
    }),
    []
  );
