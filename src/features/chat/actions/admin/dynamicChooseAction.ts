...
export async function dynamicChooseAction(params: ActionExecutionParams): Promise<ActionExecutionResult> {
  ...
  try {
    ...
    console.log('[dynamicChooseAction] Checking for existing specs for session_id:', conversationId);
    ...
    console.log('[dynamicChooseAction] Found existing specs:', hasExistingSpecs);
