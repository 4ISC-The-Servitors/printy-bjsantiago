-- Remove the helper formatting functions
DROP FUNCTION IF EXISTS format_order_status(text);
DROP FUNCTION IF EXISTS format_ticket_status(text);
DROP FUNCTION IF EXISTS format_quote_status(text);

-- Revert notify_order_events to use unformatted status
...
-- Revert notify_ticket_events to use unformatted status
...
-- Revert notify_quote_events to use unformatted status
